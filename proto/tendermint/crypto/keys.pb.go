...
type PublicKey struct {
	...
	//	*PublicKey_Ed25519
	//	*PublicKey_Secp256K1
	//	*PublicKey_AegisHybridEd25519Mldsa44
...
type PublicKey_AegisHybridEd25519Mldsa44 struct {
	AegisHybridEd25519Mldsa44 []byte `protobuf:"bytes,3,opt,name=aegis_hybrid_ed25519_mldsa44,json=aegisHybridEd25519Mldsa44,proto3,oneof" json:"aegis_hybrid_ed25519_mldsa44,omitempty"`
}

func (*PublicKey_Ed25519) isPublicKey_Sum()                   {}
func (*PublicKey_Secp256K1) isPublicKey_Sum()                 {}
func (*PublicKey_AegisHybridEd25519Mldsa44) isPublicKey_Sum() {}
...
func (m *PublicKey) GetAegisHybridEd25519Mldsa44() []byte {
	if x, ok := m.GetSum().(*PublicKey_AegisHybridEd25519Mldsa44); ok {
		return x.AegisHybridEd25519Mldsa44
	}
	return nil
}
...
func (*PublicKey) XXX_OneofWrappers() []interface{} {
	return []interface{}{
		...
		(*PublicKey_AegisHybridEd25519Mldsa44)(nil),
	}
}
...
var fileDescriptor_cb048658b234868c = []byte{
	...
	0x44, 0xd2, 0xf3, 0xd3, 0xf3, 0xc1, 0xb2, 0xfa, 0x20, 0x16, 0x44, 0xa1, 0xd2, 0x6c, 0x46, 0x2e,
	...
	0x16, 0x21, 0x24, 0xe4, 0xc8, 0x25, 0x93, 0x98, 0x9a, 0x9e, 0x59, 0x1c, 0x9f, 0x51, 0x99, 0x54,
	0x94, 0x99, 0x12, 0x0f, 0xd5, 0x17, 0x9f, 0x9b, 0x93, 0x52, 0x9c, 0x68, 0x62, 0x22, 0xc1, 0x0c,
	0xd5, 0x22, 0x09, 0x56, 0xe5, 0x01, 0x56, 0xe4, 0x0a, 0x51, 0xe3, 0x0b, 0x51, 0x62, 0xc5, 0xf1,
	0x62, 0x81, 0x3c, 0xe3, 0x8b, 0x85, 0xf2, 0x8c, 0x4e, 0xac, 0x5c, 0xcc, 0xc5, 0xa5, 0xb9, 0x4e,
	...
	0x51, 0x9a, 0xa4, 0x97, 0x9c, 0x9f, 0xab, 0x9f, 0x9c, 0x9f, 0x9b, 0x5a, 0x92, 0x94, 0x56, 0x82,
	0x60, 0x40, 0xbc, 0x89, 0x11, 0x42, 0x49, 0x6c, 0x60, 0x09, 0x63, 0x40, 0x00, 0x00, 0x00, 0xff,
	0xff, 0xb8, 0x47, 0x49, 0x68, 0x3d, 0x01, 0x00, 0x00,
}
...
func (this *PublicKey) Compare(that interface{}) int {
	...
	if that1.Sum == nil {
		...
		case *PublicKey_Secp256K1:
			thisType = 1
		case *PublicKey_AegisHybridEd25519Mldsa44:
			thisType = 2
		default:
...
func (this *PublicKey_AegisHybridEd25519Mldsa44) Compare(that interface{}) int {
	if that == nil {
		if this == nil {
			return 0
		}
	...
	that1, ok := that.(*PublicKey_AegisHybridEd25519Mldsa44)
	if !ok {
		that2, ok := that.(PublicKey_AegisHybridEd25519Mldsa44)
		if ok {
			that1 = &that2
		} else {
			return 1
	...
	if c := bytes.Compare(this.AegisHybridEd25519Mldsa44, that1.AegisHybridEd25519Mldsa44); c != 0 {
		return c
	}
	return 0
}
...
func (this *PublicKey_AegisHybridEd25519Mldsa44) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}
	...
	if !bytes.Equal(this.AegisHybridEd25519Mldsa44, that1.AegisHybridEd25519Mldsa44) {
		return false
	}
	return true
}
...
func (m *PublicKey_AegisHybridEd25519Mldsa44) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *PublicKey_AegisHybridEd25519Mldsa44) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.AegisHybridEd25519Mldsa44 != nil {
		i -= len(m.AegisHybridEd25519Mldsa44)
		copy(dAtA[i:], m.AegisHybridEd25519Mldsa44)
		i = encodeVarintKeys(dAtA, i, uint64(len(m.AegisHybridEd25519Mldsa44)))
		i--
		dAtA[i] = 0x1a
	}
	return len(dAtA) - i, nil
...
func (m *PublicKey_AegisHybridEd25519Mldsa44) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	_ = l
	if m.AegisHybridEd25519Mldsa44 != nil {
		l = len(m.AegisHybridEd25519Mldsa44)
		n += 1 + l + sovKeys(uint64(l))
	}
	return n
}
...
func (m *PublicKey) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field AegisHybridEd25519Mldsa44", wireType)
			}
			var byteLen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			v := make([]byte, postIndex-iNdEx)
			copy(v, dAtA[iNdEx:postIndex])
			m.Sum = &PublicKey_AegisHybridEd25519Mldsa44{v}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
